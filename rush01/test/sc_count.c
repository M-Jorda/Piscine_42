...
/*   Updated: 2024/08/05 15:57:38 by jjorda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	satisfies_clues(t_puzzle *puzzle)
{
	...
	while (i < puzzle->size)
	{
		if (puzzle->top_clues[i] != 0 && count_visible_from_top(puzzle, i) != puzzle->top_clues[i])
		{
			return (0);
		}
		if (puzzle->bottom_clues[i] != 0 && count_visible_from_bottom(puzzle, i) != puzzle->bottom_clues[i])
		{
			return (0);
		}
		if (puzzle->left_clues[i] != 0 && count_visible_from_left(puzzle, i) != puzzle->left_clues[i])
		{
			return (0);
		}
		if (puzzle->right_clues[i] != 0 && count_visible_from_right(puzzle, i) != puzzle->right_clues[i])
		{
			return (0);
		}
		i++;
